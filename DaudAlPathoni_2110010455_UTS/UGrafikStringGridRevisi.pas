...
type
  TFormGrafikStringGridRevisi = class(TForm)
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
    cbb1: TComboBox;
...
var
  FormGrafikStringGridRevisi: TFormGrafikStringGridRevisi;

implementation

{$R *.dfm}

{ TFormGrafikStringGridRevisi }

procedure TFormGrafikStringGridRevisi.charadd;
var i:Integer;
begin
...
procedure TFormGrafikStringGridRevisi.FormShow(Sender: TObject);
begin
...
procedure TFormGrafikStringGridRevisi.Button2Click(Sender: TObject);
begin
...
procedure TFormGrafikStringGridRevisi.Button3Click(Sender: TObject);
var a,b:Integer;
begin
...
procedure TFormGrafikStringGridRevisi.Button1Click(Sender: TObject);
begin
